...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('templates/vendor/datatables/dataTables.bootstrap4.min.css') }}">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Aplikasi <sup>Nilai</sup></div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Nilai SMK MUTHIA HARAPAN CICALENGKA 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{ asset('templates/vendor/datatables/jquery.dataTables.js') }}"></script>
